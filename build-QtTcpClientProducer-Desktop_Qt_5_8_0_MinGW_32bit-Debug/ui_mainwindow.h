...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QObject::connect(horizontalSlider_time, SIGNAL(valueChanged(int)), label_5, SLOT(setNum(int)));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_3->setText(QApplication::translate("MainWindow", "Host", Q_NULLPTR));
        ...
        label_4->setText(QApplication::translate("MainWindow", "Timeout(s)", Q_NULLPTR));
        label_5->setText(QApplication::translate("MainWindow", "1", Q_NULLPTR));
